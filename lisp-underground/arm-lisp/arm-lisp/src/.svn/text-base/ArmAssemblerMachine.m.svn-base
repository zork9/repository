...
- (int)pushLoopGoto:(NSString*)l
{
	...
	NSString *s = [NSString stringWithFormat:@"b %@", l];
	[_bytecode addObject: s];
	NSLOG2(@"arm assembler : pushed b %@",l);
	return 0;

}

- (int)pushReturnFromLinkedBranch
{

	NSString *s = [NSString stringWithFormat:@"mov pc,lr"];
	[_bytecode addObject: s];
	NSLOG(@"arm assembler : pushed mov pc,lr");
	return 0;
