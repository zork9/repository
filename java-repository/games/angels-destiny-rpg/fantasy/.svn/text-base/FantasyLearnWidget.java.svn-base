...
class FantasyLearnWidget extends FantasyWidget
{
protected FantasyLearnListVerticalWidget listwidget = new FantasyLearnListVerticalWidget(0,0); 

protected Image backgroundimage;
protected String prefix = "pics/";
public FantasyLearnWidget(int sx, int sy, int sz)
{
	super(sx,sy);
	listwidget.setx(sx);
	listwidget.sety(sy);
