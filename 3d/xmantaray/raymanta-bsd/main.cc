...
#include <Xlib.h> // Every Xlib program must include this
...
//FIXME--tullarisc #include "config.h"
...
//	init(&dpy,&w);
        ray3d::PixmapTextureModelRotate pm3(dpyb.get_display(),&w,&gc,"./gradient.xpm",24,24); //--tullarisc post.xpm
  ...
  for (int k = 0; k < 100000; k++) {
	...
	XDrawLine(dpy,w,gc,0,0,400,400);
	XFlush(dpy);
  }
  sleep(20);
